...
fun main() {
    ...
    println("Готовность корабля к плаванию:${((damageShip== DAMAGE_SHIP)&&(numberOfCrew<= MAX_NUMBER_OF_CREW)&&(numberOfCrew>= MIN_NUMBER_OF_CREW)&&(quantityOfProvisions> QUANTITY_OF_PROVISIONS)&&(favorableWeather== FAVORABLE_WEATHER))||
